...
| OS | Script |
|---|---|
| **Windows** | Double-click `Install and Run - Windows.bat` |
| **Windows (Web UI)** | Double-click `Install and Run Web UI - Windows.bat` |
| **macOS** | Double-click `Install and Run - Mac.command` |
| **Linux** | `chmod +x "Install and Run - Linux.sh" && "./Install and Run - Linux.sh"` |

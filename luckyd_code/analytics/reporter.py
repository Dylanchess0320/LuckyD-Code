...
class ReportGenerator:
    ...
    def __init__(self, pm: ProjectMetrics, smells: list[Smell] | None = None) -> None:
        self.pm = pm
        self.smells: list[Smell] = smells or []
...
def generate_report(
    ...
    gen = ReportGenerator(pm, smells or [])
    report = gen.terminal()
